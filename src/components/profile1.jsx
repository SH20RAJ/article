...
* @see https://v0.dev/t/eyRDbF8zV3c
    ...
    (<div className="flex flex-col min-h-[100dvh]">
      ...
      <main className="container mx-auto px-4 md:px-6 py-12">
        <div className="flex flex-col items-center space-y-2">
          ...
          <p className="text-muted-foreground">Software Engineer | Vercel</p>
          <p className="max-w-md text-center text-muted-foreground">
            I'm a software engineer at Vercel, where I work on the Next.js framework. In my free time, I enjoy hiking
            and photography.
          </p>
