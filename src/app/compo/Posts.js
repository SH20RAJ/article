...
export default function Posts() {
  return (
    <>
      <div className="mb-28">
        <div className="wrapper translate-x-[0] opacity-1 duration-500 mt-28 grid font-poppins grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 p-2 lg:p-6">
          <div
          ...
          >
            ...
            <div className="flex justify-between p-5 bg-white">
              <div>
                ...
                <p className="text-sm">
                  Compiling the top 10 most used icons library in React{/* */}{" "}
                  by{/* */} {/* */}
                  <span className="font-medium uppercase">User Name</span>
                </p>
              </div>
